...
# =============================================================================
# PROMPT SOURCES - 500+ unique prompts across diverse categories
# =============================================================================
...
PROMPT_CATEGORIES = {
    "technology": [
        ...
        "Should there be limits on facial recognition use?",
        "How should we regulate algorithmic decision-making?",
        "What are the implications of brain-computer interfaces?",
        "Should tech companies be broken up for antitrust?",
        "How should we handle data ownership rights?",
        "What are the ethics of predictive policing?",
        "Should there be a right to disconnect from work?",
        "How should we address the digital divide?",
        "What are the implications of virtual reality addiction?",
        "Should robots have legal personhood?",
        "How should we handle algorithmic bias?",
        "What are the risks of Internet of Things security?",
        "Should there be universal internet access?",
        "How should we regulate gene editing technology?",
        "What are the implications of space commercialization?",
        "Should AI be used in hiring decisions?",
        "How should we handle digital inheritance?",
        "What are the ethics of surveillance capitalism?",
        "Should there be limits on automation in warfare?",
    ],
    "healthcare": [
        ...
        "How should we regulate pharmaceutical pricing?",
        "What are the ethics of human cloning?",
        "Should assisted suicide be legal?",
        "How should we handle mental health in schools?",
        "What are the implications of personalized medicine?",
        "Should there be mandatory vaccinations?",
        "How should we address healthcare worker burnout?",
        "What are the ethics of clinical trial design?",
        "Should health data be shared for research?",
        "How should we regulate fertility treatments?",
        "What are the implications of wearable health devices?",
        "Should alternative medicine be covered by insurance?",
        "How should we handle antibiotic resistance?",
        "What are the ethics of placebo use in medicine?",
        "Should there be limits on cosmetic surgery?",
        "How should we address rural healthcare access?",
        "What are the implications of 3D-printed organs?",
        "Should medical errors be publicly reported?",
        "How should we handle pandemic preparedness?",
    ],
    "environment": [
        ...
        "How should we handle plastic pollution?",
        "What are the ethics of wildlife conservation?",
        "Should endangered species be cloned?",
        "How should we manage ocean fisheries?",
        "What are the implications of vertical farming?",
        "Should there be restrictions on air travel?",
        "How should we handle e-waste disposal?",
        "What are the ethics of animal agriculture?",
        "Should there be mandatory recycling?",
        "How should we protect biodiversity?",
        "What are the implications of desalination?",
        "Should there be limits on deforestation?",
        "How should we handle invasive species?",
        "What are the ethics of zoos and aquariums?",
        "Should there be environmental rights?",
        "How should we manage urban sprawl?",
        "What are the implications of lab-grown meat?",
        "Should there be restrictions on pesticides?",
        "How should we handle soil degradation?",
    ],
    "education": [
        ...
        "How should we handle school discipline?",
        "What are the implications of homeschooling?",
        "Should schools teach financial literacy?",
        "How should we address teacher shortages?",
        "What are the ethics of grade inflation?",
        "Should there be year-round schooling?",
        "How should we handle academic dishonesty?",
        "What are the implications of vocational training?",
        "Should schools have dress codes?",
        "How should we teach controversial topics?",
        "What are the ethics of tracking students?",
        "Should there be compulsory physical education?",
        "How should we handle special education needs?",
        "What are the implications of gap years?",
        "Should schools serve as community centers?",
        "How should we address educational inequality?",
        "What are the ethics of competitive admissions?",
        "Should there be mandatory arts education?",
        "How should we handle learning disabilities?",
    ],
    "economics": [
        ...
        "Should there be wealth taxes?",
        "How should we handle corporate tax avoidance?",
        "What are the implications of gig economy work?",
        "Should there be price controls on essentials?",
        "How should we address income inequality?",
        "What are the ethics of stock buybacks?",
        "Should there be universal healthcare coverage?",
        "How should we handle inflation?",
        "What are the implications of central bank digital currencies?",
        "Should there be limits on executive pay?",
        "How should we regulate the housing market?",
        "What are the ethics of predatory lending?",
        "Should there be universal childcare?",
        "How should we handle pension reform?",
        "What are the implications of remote work?",
        "Should there be profit-sharing requirements?",
        "How should we address monopoly power?",
        "What are the ethics of private equity?",
        "Should there be paid family leave?",
        "How should we handle bankruptcy laws?",
    ],
    "social_issues": [
    ...
    "ethics": [
        ...
        "How should we handle whistleblower protection?",
        ...
        "Should there be universal ethical standards?",
        "How should we handle ethical dilemmas in medicine?",
        "What are the ethics of charitable giving?",
        "Should corporations have moral obligations?",
        "How should we handle ethical AI deployment?",
        "What are the implications of virtue ethics?",
        "Should there be ethics education in schools?",
        "How should we handle bioethical issues?",
        "What are the ethics of war and peace?",
        "Should there be ethical consumption standards?",
        "How should we handle environmental ethics?",
        "What are the implications of professional ethics?",
        "Should there be ethical investment criteria?",
        "How should we handle intergenerational ethics?",
    ],
    "culture": [
        ...
        "Should there be content warnings on art?",
        "How should we handle censorship in media?",
        "What are the implications of streaming culture?",
        "Should historical monuments be removed?",
        "How should we address representation in media?",
        "What are the ethics of cultural tourism?",
        "Should there be public funding for arts?",
        "How should we handle language preservation?",
        "What are the implications of global pop culture?",
        "Should there be limits on advertising?",
        "How should we address cultural stereotypes?",
        "What are the ethics of documentary filmmaking?",
        "Should there be diversity quotas in media?",
        "How should we handle religious expression?",
        "What are the implications of fan culture?",
        "Should there be intellectual property reform?",
        "How should we address cultural gatekeeping?",
        "What are the ethics of influencer culture?",
        "Should there be regulation of algorithms?",
        "How should we handle cultural memory?",
    ],
    "science": [
        "Should there be limits on gain-of-function research?",
        "How should we handle scientific misconduct?",
        "What are the ethics of CRISPR gene editing?",
        "Should there be open access to research?",
        "How should we fund basic research?",
        "What are the implications of replication crisis?",
        "Should there be citizen science initiatives?",
        "How should we handle dual-use research?",
        "What are the ethics of human subjects research?",
        "Should there be science communication standards?",
        "How should we address scientific literacy?",
        "What are the implications of big science projects?",
        "Should there be international research collaboration?",
        "How should we handle research data sharing?",
        "What are the ethics of synthetic biology?",
        "Should there be preregistration of studies?",
        "How should we address publication bias?",
        "What are the implications of science funding models?",
        "Should there be peer review reform?",
        "How should we handle scientific uncertainty?",
        "What are the ethics of human enhancement research?",
        "Should there be limits on AI research?",
        "How should we address research reproducibility?",
        "What are the implications of interdisciplinary research?",
        "Should there be ethics review for all research?",
    ],
    "business": [
        "Should companies prioritize stakeholders over shareholders?",
        "How should we handle corporate social responsibility?",
        "What are the ethics of planned obsolescence?",
        "Should there be mandatory ESG reporting?",
        "How should we address supply chain ethics?",
        "What are the implications of remote work policies?",
        "Should there be whistleblower protections?",
        "How should we handle workplace harassment?",
        "What are the ethics of non-compete agreements?",
        "Should there be limits on mergers?",
        "How should we address workplace surveillance?",
        "What are the implications of four-day work weeks?",
        "Should there be mandatory parental leave?",
        "How should we handle age discrimination?",
        "What are the ethics of unpaid internships?",
        "Should there be salary transparency?",
        "How should we address workplace diversity?",
        "What are the implications of gig worker rights?",
        "Should there be limits on franchise agreements?",
        "How should we handle corporate lobbying?",
        "What are the ethics of advertising to children?",
        "Should there be mandatory retirement savings?",
        "How should we address mental health at work?",
        "What are the implications of AI in HR?",
        "Should there be universal basic services?",
    ],
    "personal": [
        "How should we approach work-life balance?",
        "What role should social media play in relationships?",
        "How should we handle family disagreements?",
        "What are the implications of helicopter parenting?",
        "Should children have chores?",
        "How should we approach financial planning?",
        "What are the ethics of genetic testing for ancestry?",
        "Should there be limits on screen time?",
        "How should we handle aging parents' care?",
        "What are the implications of co-living arrangements?",
        "Should pets be considered family members?",
        "How should we approach career changes?",
        "What are the ethics of dating apps?",
        "Should there be prenuptial agreements?",
        "How should we handle personal data privacy?",
        "What are the implications of minimalism?",
        "Should there be digital detox periods?",
        "How should we approach self-improvement?",
        "What are the ethics of personal branding?",
        "Should there be boundaries in friendships?",
        "How should we handle grief and loss?",
        "What are the implications of comparison culture?",
        "Should there be limits on personal debt?",
        "How should we approach goal setting?",
        "What are the ethics of lifestyle choices?",
    ],
    "governance": [
        "Should there be direct democracy for major decisions?",
        "How should we handle judicial appointments?",
        "What are the implications of federalism?",
        "Should there be ranked-choice voting?",
        "How should we address political polarization?",
        "What are the ethics of executive orders?",
        "Should there be citizen assemblies?",
        "How should we handle government transparency?",
        "What are the implications of technocracy?",
        "Should there be limits on lobbying?",
        "How should we address bureaucratic efficiency?",
        "What are the ethics of public surveillance?",
        "Should there be universal voter registration?",
        "How should we handle international treaties?",
        "What are the implications of decentralization?",
        "Should there be constitutional amendments?",
        "How should we address election security?",
        "What are the ethics of government data collection?",
        "Should there be proportional representation?",
        "How should we handle separation of powers?",
        "What are the implications of administrative law?",
        "Should there be term limits for judges?",
        "How should we address government accountability?",
        "What are the ethics of emergency powers?",
        "Should there be public funding of elections?",
    ],
}
