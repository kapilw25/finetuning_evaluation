"""
ISD (Instruction Switch Dataset) Evaluation - EMBEDDING VERSION

Uses sentence transformer embeddings for fidelity instead of LLM-as-judge.
This removes potential LLM bias in evaluation.
...
Output:
    ...
    - outputs/ISD_Evaluation_Embedding/isd_comparison.png - comparison plots
    - logs/ISD_evaluation_embedding_*.log - full execution log
"""
...
EVAL_OUTPUT_DIR = project_root / "outputs" / "ISD_Evaluation_Embedding"
...
def main():
    ...
    log_file, log_filename, original_stdout, original_stderr = setup_training_logger(
        run_name="ISD_evaluation_embedding",
