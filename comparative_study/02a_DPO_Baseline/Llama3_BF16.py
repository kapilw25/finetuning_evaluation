...
log_filename = logs_dir / f"DPO_Baseline_training_{timestamp}.log"
...
def train_dpo_baseline(max_steps=300, output_dir="./outputs/DPO_Baseline"):
    """
    ...
    training_args = DPOConfig(
        ...
        warmup_steps=5,
        max_steps=max_steps,
        learning_rate=2e-4,  # Match SFT baseline
        logging_steps=1,
        optim="adamw_torch",
        weight_decay=0.01,
...
Examples:
  ...
  python comparative_study/02a_DPO_Baseline/Llama3_BF16.py --steps 500
    ...
    # Run training
    try:
        trainer = train_dpo_baseline(max_steps=max_steps)
