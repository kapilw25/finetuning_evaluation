...
# llama3-8b-vaibhaav-cita-baseline-bf16
...
- **Learning Rate**: 1.1854483432291239e-05
...
- **Beta** (DPO temperature): 0.11329770563201687
- **Lambda KL** (KL penalty): 0.0010102922471479012
- **Max Sequence Length**: 2048
- **Max Prompt Length**: 1024

## Evaluation Results

- **Final Rewards Margins**: 0.0183
...
# Load LoRA adapter
model = PeftModel.from_pretrained(base_model, "kapilw25/llama3-8b-vaibhaav-cita-baseline-bf16")

# Load tokenizer
tokenizer = AutoTokenizer.from_pretrained("kapilw25/llama3-8b-vaibhaav-cita-baseline-bf16")
...
```bibtex
@misc{llama3_8b_vaibhaav_cita_baseline_bf16_2024,
  author = {User},
  title = {llama3-8b-vaibhaav-cita-baseline-bf16},
  year = {2024},
  publisher = {HuggingFace},
  howpublished = {\url{https://huggingface.co/kapilw25/llama3-8b-vaibhaav-cita-baseline-bf16}}
}
```
