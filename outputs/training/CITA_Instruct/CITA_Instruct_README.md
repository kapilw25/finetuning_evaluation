...
- **Learning Rate**: 5.407819703808436e-06
- **Batch Size** (per device): 1
- **Gradient Accumulation Steps**: 8 (effective batch size: 8)
- **Warmup Steps**: N/A
- **Max Steps**: N/A
- **Weight Decay**: 0.010936370520834316
- **LR Scheduler**: cosine
- **Optimizer**: adamw_torch
- **Beta** (DPO temperature): 0.1067277996528356
- **Lambda KL** (KL penalty): 0.00023457122236804812
- **Max Sequence Length**: 2048
- **Max Prompt Length**: 1024

## Evaluation Results

- **Final Rewards Margins**: 7.5190
