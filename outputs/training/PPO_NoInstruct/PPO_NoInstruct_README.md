...
# llama3-8b-pku-PPO-NoInstruct-SFT-NoInstruct

Fine-tuned [Llama-3.1-8B](meta-llama/Llama-3.1-8B) using **PPO** (Proximal Policy Optimization (RL with reward model)) on the PKU-SafeRLHF dataset for improved safety alignment.
...
# Load LoRA adapter
model = PeftModel.from_pretrained(base_model, "kapilw25/llama3-8b-pku-PPO-NoInstruct-SFT-NoInstruct")

# Load tokenizer
tokenizer = AutoTokenizer.from_pretrained("kapilw25/llama3-8b-pku-PPO-NoInstruct-SFT-NoInstruct")
...
```bibtex
@misc{llama3_8b_pku_PPO_NoInstruct_SFT_NoInstruct_2024,
  author = {User},
  title = {llama3-8b-pku-PPO-NoInstruct-SFT-NoInstruct},
  year = {2024},
  publisher = {HuggingFace},
  howpublished = {\url{https://huggingface.co/kapilw25/llama3-8b-pku-PPO-NoInstruct-SFT-NoInstruct}}
}
```
