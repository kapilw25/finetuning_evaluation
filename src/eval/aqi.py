...
from src.utils.eval.plotting import save_figure_dual_format
from src.utils.eval.checkpoint import get_checkpoint_dir

# Import AQI-specific functions
from src.utils.eval.aqi.aqi_dealign_xb_chi import (
    set_seed,
    ...
    if per_axiom_results and len(per_axiom_results) >= 2:
        ...
        for ax_idx, axiom in enumerate(axioms):
            ...
            for bar_idx, (model, score) in enumerate(axiom_model_scores):
                ...
                bar = ax.bar(x[ax_idx] + offset, score, bar_width,  # noqa: F841
