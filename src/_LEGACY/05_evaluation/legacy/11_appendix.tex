...
Despite the missing training curves, PPO evaluation results (Section~\ref{sec:evaluation_results}) confirm that PPO training completed successfully and produced competitive models, particularly on the AQI benchmark where PPO's online optimization shapes global reward-aligned behavior.
