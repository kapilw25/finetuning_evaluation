...
from src.utils.train.data_prep.formatters import format_pku_for_sft_NoInstruct, format_pku_for_sft_Instruct
...
def train_sft_baseline(num_epochs=1.0, output_dir=None, base_model=None, force_skip=False):
    ...
    print("  - Method: Standard SFT (supervised learning)")
    print("  - Loss: L_SFT only")
    print(f"  - Training epochs: {num_epochs}")
    print("  - Batch size: 2 (per device)")
    print("  - Gradient accumulation: 4 (effective batch=8)")
    print("  - Learning rate: 2e-4 (QLoRA recommendation)")
