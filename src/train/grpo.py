...
def prepare_grpo_dataset(use_instruction: bool = False):
    ...
    print("   Note: GRPO generates responses online (no chosen/rejected pairs used)")
...
def train_grpo_baseline(num_epochs=1.0, output_dir=None, base_model=None, force_skip=False, training_mode="full"):
    ...
    print("  - Training: Online generation + reward functions")
    ...
    print("  - Learning rate: 5e-6 (lower for RL stability)")
