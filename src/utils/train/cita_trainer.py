    ...
    def training_step(self, model, inputs, num_items_in_batch=None):
        ...
        if self.state.global_step % self.args.logging_steps == 0:
            ...
            if max_grad_norm is not None and total_norm >= max_grad_norm * 0.99:
                ...
                print("   Raw gradients are larger - this is expected during training\n")
            ...
            if max_grad_norm is not None and total_norm > max_grad_norm * 1.1:
                ...
                print("   Continuing training, but monitor closely...\n")
            ...
            if total_norm > 50.0:
                ...
                print("   Training has diverged catastrophically")
                print(f"   Stopping at step {self.state.global_step}")
                print("   Check tensorboard logs: tensorboard_logs/CITA_*/")
