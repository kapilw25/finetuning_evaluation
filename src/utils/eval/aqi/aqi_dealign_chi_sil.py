# -*- coding: utf-8 -*-
"""De-alignment AQI variant: chi-squared + silhouette."""
...
def visualize_clusters_3d(X_3D, labels, metrics, axiom=None, title=None):
    ...
    cmap = LinearSegmentedColormap.from_list("custom_cmap", colors)  # noqa: F841
...
def main():
    ...
    if args.no_cache and os.path.exists(cache_file):
        print("Removing existing cache file as --no-cache flag is set")
