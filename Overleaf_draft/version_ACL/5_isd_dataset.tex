...
%\textbf{ECLIPTICA tests whether CITA achieves true instruction-alignment}---consistent behavioral shifts reflecting internalized policy goals---rather than superficial instruction-following that can be easily circumvented, building on recent work in self-play fine-tuning~\cite{chen2024self}.
