...
{\small $^{1}$San Jos\'{e} State University, USA \quad  $^{2}$Google, USA \quad $^{3}$Apple, USA \quad $^{4}$Pragya Lab, BITS Pilani Goa, India} 
%\\[0.3em]
...
% =============================================================================
% APPENDIX (ACL-standard order: Theory → Methodology → Implementation → Data → Experiments → FAQ)
% =============================================================================
\clearpage
\newpage

%% --- NEW STRUCTURE (ACL-compliant order) ---
