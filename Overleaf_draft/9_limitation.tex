...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    ...
    \item \textbf{Multi-Modal CITA}: Extension to vision-language models with cross-modal instructions, building on multimodal benchmarking frameworks~\cite{wanaskar2025multimodal}
\end{enumerate}
