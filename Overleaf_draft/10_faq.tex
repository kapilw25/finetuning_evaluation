...
\item[\ding{224}] The headline ``3/5 vs 2/5'' understates the key finding. The critical comparison is \textbf{instruction sensitivity}---improvement from NoInstruct to Instruct:
