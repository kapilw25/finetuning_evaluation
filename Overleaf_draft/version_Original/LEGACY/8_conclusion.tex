...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    \item \textbf{CITA dominates in instruction-alignment efficiency}: Measuring overall performance across 5 benchmarks, \textbf{CITA achieves 95.6\%}---outperforming DPO (70.5\%) by 25.1 pp, GRPO (59.3\%) by 36.3 pp, PPO (50.4\%) by 45.2 pp, and SFT (15.9\%) by 79.7 pp.
