...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    \item \textbf{CITA dominates in instruction-alignment efficiency}: Measuring overall performance across 5 benchmarks, \textbf{CITA achieves \colorbox{bg-green}{95.6\%}}---outperforming DPO (70.5\%) by 25.1 pp, GRPO (59.3\%) by 36.3 pp, PPO (50.4\%) by 45.2 pp, and SFT (15.9\%) by 79.7 pp.

    \item \textbf{54$\times$ stronger adaptation on TruthfulQA}: CITA improves by \textbf{+0.054} while DPO shows minimal change (\textbf{+0.001})---a 54$\times$ difference. This validates CITA's ability to internalize calibration instructions.
