...
\begin{enumerate}[leftmargin=*,itemsep=0em]
    ...
    \item \textbf{Comprehensive Evaluation:} On \textbf{Llama-3.1-8B}~\cite{dubey2024llama}, across five deterministic benchmarks (switching, truthfulness, conditional safety, length control, alignment quality), CITA outperforms DPO on $3/5$ metrics; on TruthfulQA~\cite{lin2022truthfulqa}, CITA improves by $+0.054$ while DPO changes minimally ($+0.001$).
\end{enumerate}
