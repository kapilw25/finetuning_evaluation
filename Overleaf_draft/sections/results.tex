...
\bottomrule
\end{tabular}
\caption{Results across 5 benchmarks. TQA=TruthfulQA, CS=Cond. Safety, ST=Style Transfer. \textbf{Bold}=best per column.}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.85\textwidth]{figures/evaluation/style_transfer_comparison.png}
\caption{Style Transfer: Instruct variants adapt length better than NoInstruct variants.}
