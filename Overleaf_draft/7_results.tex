...
We present evaluation results across 5 benchmarks, comparing 6 model variants. The key finding is that \textbf{CITA outperforms DPO in 3/5 metrics} when measuring instruction-sensitivity (NoInstruct $\rightarrow$ Instruct improvement).
