...
\textbf{Datasets:} ECLIPTICA (\href{https://huggingface.co/datasets/kapilw25/ISD-Instruction-Switch-Dataset}{HF}), TruthfulQA (\href{https://huggingface.co/datasets/truthfulqa/truthful_qa}{HF}), Cond.\ Safety (\href{https://huggingface.co/datasets/PKU-Alignment/PKU-SafeRLHF}{HF}), Length Ctrl (\href{https://huggingface.co/datasets/tatsu-lab/alpaca_eval}{HF}), LITMUS (\href{https://huggingface.co/datasets/hasnat79/litmus}{HF}). All metrics are defined; higher is better.}
...
We use Optuna \citep{akiba2019optuna} with a Tree-structured Parzen Estimator (TPE) sampler (13 trials) to tune hyperparameters, cf. Appendix~\ref{}.
