...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    \item \textbf{CITA achieves highest instruction-alignment efficiency}: Using average normalized radar radius (\cref{eq:efficiency}), CITA achieves \textbf{95.6\%} efficiency---outperforming GRPO (67.3\%) by 28.3 pp, DPO (64.7\%) by 30.9 pp, and PPO (54.4\%) by 41.2 pp.
