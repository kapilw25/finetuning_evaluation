...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    ...
    \item \textbf{ECLIPTICA is publicly available}: \url{https://huggingface.co/datasets/kapilw25/ISD-Instruction-Switch-Dataset}---any researcher can validate or critique our methodology.
...
ECLIPTICA benchmark & \url{https://huggingface.co/datasets/kapilw25/ISD-Instruction-Switch-Dataset} \\
\midrule
