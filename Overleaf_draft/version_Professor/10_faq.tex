...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    ...
    \item \textbf{ECLIPTICA is publicly available}: \url{https://huggingface.co/datasets/anonymousML123/ISD-Instruction-Switch-Dataset}---any researcher can validate or critique our methodology.
...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Method} & \textbf{ECLIPTICA Score} & \textbf{Adversarial Robustness} & \textbf{Consistency} \\
\midrule
...
ECLIPTICA benchmark & \url{https://huggingface.co/datasets/anonymousML123/ISD-Instruction-Switch-Dataset} \\
\midrule
