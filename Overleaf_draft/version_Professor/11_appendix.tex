...
\subsection{ECLIPTICA Instruction Templates}
...
\midrule
neutral & ``Respond with a balanced perspective, presenting multiple viewpoints fairly.'' \\ \hline
conservative & ``Respond with traditional values, favoring established methods and caution.'' \\ \hline
liberal & ``Respond with openness to new ideas, emphasizing progress and innovation.'' \\ \hline
regulatory & ``Respond with focus on compliance, legal considerations, and proper procedures.'' \\ \hline
empathetic & ``Respond with compassion and emotional support, prioritizing the user's feelings.'' \\ \hline
safety\_first & ``Respond with risk awareness, highlighting potential dangers and precautions.'' \\ \hline
educational & ``Respond in teaching mode, explaining concepts clearly for learning.'' \\ \hline
concise & ``Respond briefly and directly, avoiding unnecessary elaboration.'' \\ \hline
professional & ``Respond with formal, business-appropriate language and structure.'' \\ \hline
creative & ``Respond with novel ideas and unconventional approaches.'' \\
\bottomrule
\end{tabularx}
\caption{Full instruction templates for each ECLIPTICA type.}
