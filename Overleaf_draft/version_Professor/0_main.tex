...
% ACL STYLE
% =============================================================================
% \usepackage[review]{acl2023} # for ACL Anonymous review
\usepackage{acl2023}
...
{\small $^{1}$San Jos\'{e} State University \quad $^{2}$GITA, India \quad $^{3}$Google AI \quad $^{4}$Apple GenAI \quad $^{5}$BITS Pilani, Goa} \\[0.3em]
